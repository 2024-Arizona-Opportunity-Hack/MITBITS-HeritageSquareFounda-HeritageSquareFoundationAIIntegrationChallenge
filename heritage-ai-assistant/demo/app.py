...
st.set_page_config(
    page_title="Ohack-24 Midbits", page_icon="./app/static/favicon.ico"
)
...
<p style="text-align: center;">
    <img src="./app/static/heritage-logo.png" width="60" alt="heritage Logo">
</p>
"""
...
st.write(
    "## Heritage Square Foundation Chatbot"
)
st.write(
    "#### Chat with your files in Google Drive directly!"
)

htt = """
<p>
    <span> Built By:   </span>
    <img src="./app/static/mitbits-logo.jpg" width="100" alt="MITBITS Logo">
</p>
"""
st.markdown(htt, unsafe_allow_html=True)
...
if "messages" not in st.session_state.keys():
    ...
    Welcome to Heritage Square Foundation's AI assistant. I'm here to help with:

    - Grant document preparation
    - Answering questions about Foundation documents
    - Providing information from our Google Drive files

    How can I assist you today?
    """
    DEFAULT_MESSAGES = [
        ChatMessage(role=MessageRole.USER, content="Hi, What Can You Do?"),
